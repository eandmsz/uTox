...
void theme_load(const THEME loadtheme) {
    ...
    switch (loadtheme) {
        ...
        case THEME_SOLARIZED_DARK: {
            ...
            COLOR_EDGE_HOVER          = COLOR_PROC(0x00FF00);
            COLOR_EDGE_ACTIVE         = COLOR_PROC(0xEE00CC);
            COLOR_ACTIVEOPTION_BKGRND = COLOR_PROC(0x0000FF);
            COLOR_ACTIVEOPTION_TEXT   = COLOR_PROC(0x00FF00);
