...
void theme_load(const THEME loadtheme) {
    ...
    switch (loadtheme) {
        ...
        case THEME_SOLARIZED_DARK: {
            ...
            COLOR_AUX_ACTIVEOPTION_BKGRND = COLOR_PROC(0x00FF00);
            COLOR_AUX_ACTIVEOPTION_TEXT   = COLOR_PROC(0xEE00CC);
            ...
            COLOR_BTN_SUCCESS_BKGRND        = COLOR_PROC(0xFFDD00);
            COLOR_BTN_SUCCESS_TEXT          = COLOR_PROC(0x0000FF);
            ...
            COLOR_BTN_DANGER_BACKGROUND     = COLOR_STATUS_BUSY;
            COLOR_BTN_DANGER_TEXT           = COLOR_MAIN_TEXT;
            COLOR_BTN_DANGER_BKGRND_HOVER   = COLOR_PROC(SOLAR_ORANGE);
            COLOR_BTN_DANGER_TEXT_HOVER     = COLOR_BKGRND_MAIN;
