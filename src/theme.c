...
void theme_load(const THEME loadtheme) {
    ...
    switch (loadtheme) {
        ...
        case THEME_SOLARIZED_DARK: {
            ...
            COLOR_AUX_EDGE_NORMAL         = COLOR_PROC(0x00FF00);
            COLOR_AUX_EDGE_HOVER          = COLOR_PROC(0xEE00CC);
            COLOR_AUX_EDGE_ACTIVE         = COLOR_PROC(0xFFDD00);
            COLOR_AUX_TEXT                = COLOR_PROC(0x0000FF);
            COLOR_AUX_ACTIVEOPTION_BKGRND = COLOR_BKGRND_LIST_HOVER;
            COLOR_AUX_ACTIVEOPTION_TEXT   = COLOR_AUX_TEXT;
