...
void theme_load(const THEME loadtheme) {
    ...
    switch (loadtheme) {
        ...
        case THEME_SOLARIZED_DARK: {
            ...
            COLOR_MAIN_TEXT_HINT    = COLOR_PROC(0x00FF00);
            ...
            COLOR_MENU_TEXT_ACTIVE  = COLOR_PROC(0xEE00CC);

            COLOR_LIST_TEXT         = COLOR_PROC(0xFFFFFF);
            COLOR_LIST_TEXT_SUBTEXT = COLOR_PROC(0xFFFFFF);

            COLOR_GROUP_SELF  = COLOR_PROC(0x0000FF);
            COLOR_GROUP_PEER  = COLOR_PROC(0x00FF00);
